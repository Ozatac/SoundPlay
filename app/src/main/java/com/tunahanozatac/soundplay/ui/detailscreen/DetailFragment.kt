...
import com.tunahanozatac.soundplay.databinding.FragmentDetailBinding
import com.tunahanozatac.soundplay.utils.ImageSizeHelper
            ...
            when (response.status) {
                ...
                Resource.Status.SUCCESS -> {
                    binding.apply {
                        ...
                        val resizedImage =
                            ImageSizeHelper.imageSizeChanger400(detailItem.artworkUrl100!!)
